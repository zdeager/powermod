...
| R-fb ×3 | TBD at layout | TPS63020 FB + jumper | Sets 5V/3.3V; values against the FB reference at schematic capture |
...
| — | VBACKUP + BAT/GND/VOUT solder pads, 5V/3.3V solder jumper | — | $0 | Copper |
