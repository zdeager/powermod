...
**Status: design complete on paper. No hardware exists yet.** Every part is selected, priced, and datasheet-verified; every net is mapped; the register map is ready for firmware review. Next step: schematic capture.
